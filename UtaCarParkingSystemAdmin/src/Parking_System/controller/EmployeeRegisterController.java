...
public class EmployeeRegisterController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  //System.out.println("HELLO_WORLDDDDD"+UTAID.length());
	 ...
	 // String driverLicense=request.getParameter("license");
	   ...
	   if(UTAID.isEmpty()|| UTAID==null)
	  {
	    ...
	    if(Phone.isEmpty()|| Phone.equals(null) || Phone.length() != 10)
	  {
		  System.out.println("here7");
		  request.setAttribute("errorMessage8", "Invalid Phone Number");
		  //getServletContext().getRequestDispatcher("/register.jsp").forward(request, response);
	   ...
	   if(!matcher.find())
		  {
		  System.out.println("here8");
			  request.setAttribute("errorMessage9", "Invalid Email");
			//  getServletContext().getRequestDispatcher("/register.jsp").forward(request, response);
	 ...
	 if(!userName.isEmpty() && !password.isEmpty() && !fname.isEmpty() && !lname.isEmpty() && !UTAID.isEmpty() && !Phone.isEmpty() && !email.isEmpty())
	 {
	 ...
	 {
		 getServletContext().getRequestDispatcher("/employee_register.jsp").forward(request, response);
