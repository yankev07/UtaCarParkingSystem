...
public class ManagerSharedUIMapTest extends CarParkingSystem_Functions {
  ...
  public void testManagerNoShow() throws Exception {
    ...
    driver.findElement(By.xpath(prop.getProperty("Lst_Registration_UserName"))).sendKeys("amazingTester");
    ...
    driver.findElement(By.xpath(prop.getProperty("Lst_Registration_Address"))).sendKeys("807 Spaniolo Dr, Arlington TX 76010");
    ...
    driver.findElement(By.xpath(prop.getProperty("Txt_Login_UserName"))).clear();
  	driver.findElement(By.xpath(prop.getProperty("Txt_Login_UserName"))).sendKeys("amazingTester");
    ...
    driver.findElement(By.xpath(prop.getProperty("Manager_SetNoShow_Username"))).sendKeys("user3");
