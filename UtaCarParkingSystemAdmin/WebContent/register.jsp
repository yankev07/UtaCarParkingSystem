...
<br>
<br>
<h2 id="txt5">U S E R &nbsp;&nbsp;&nbsp;R E G I S T R A T I O N</h2>
<table border="0" id="tbl1">
<form name="userRegister" action="RegisterController" method="post" >
<tr>
...
<tr>
<td id="txt9">Parking Type</td>
<td>&nbsp;&nbsp;&nbsp;
<select name ="parking" value='${data.parkingType}' >
<option  >Basic</option>
...
<tr>
<td id="txt9">Driver License</td>
<td>&nbsp;&nbsp;&nbsp;<input type="text" name="license" value=<%= driverLicense %>></td>
<td>&nbsp;&nbsp;&nbsp;<label for "emptyString" style="color:red" > ${errorMessage5} </td>
</tr>
<tr>
<td id="txt9">Role</td>
<td>&nbsp;&nbsp;&nbsp;
...
<tr>
<td><input type="submit" name="submit" value="Register" id="btn1"></td>
</tr>
