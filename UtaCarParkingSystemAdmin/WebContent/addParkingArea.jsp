...
<a href="User_Home.jsp"><div id="txt7">Update Profile</div></a>
...
<td id="d2"> 
<center><h1 id="txt11">ADD A NEW PARKING AREA</h1></center>
<table border="0" id="tbl1">
<form name="f1" method="post" action="addParkingAreaController">
<tr>
<td id="txt14">Name</td>
...
<tr>
<td></td>
<td><br><input type="submit" value="ADD" id="btn2"></td>
</tr>
</form>
</table>
</td>
