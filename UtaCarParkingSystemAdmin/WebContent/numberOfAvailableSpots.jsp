...
<td id="d2">
    <CENTER><h1 id="txt11">NUMBER OF AVAILABLE SPOTS</h1></CENTER>
    <form method="post">
...
Class.forName("com.mysql.cj.jdbc.Driver");
    ...
    %>
        <tr>
            ...
            <td><%=rs.getString("space") %></td>
            <td><%=rs.getString("floors") %></td>
            <td><%=rs.getString("occupied") %></td>
            <td><%=rs.getString("unavailable") %></td>
